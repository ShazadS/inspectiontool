...
class HPromise extends Component {

    constructor(props) {
        // console.log("HPromise constructor ");
        super(props);
        // Meteor.call('checklistvalues.halloserver', "HPromise-constructor");
        this.state = { "params": {} };
    }
    ...
    createChecklistFunc(mains_record, mains_id, checklisttype) {
        ...
        // ignore checklisttype , is always "H-Promise"
    ...
    render() {
        // console.log("HPromise USERNAME " + this.props.currentusername);
        // console.log("HPromise COMPANY  " + this.props.currentcompany);
        // console.log("HPromise DEALER   " + this.props.currentdealer);
        // console.log("HPromise ROLE     " + this.props.currentrole);
            ...
            if (this.state.params && this.state.params.mains_record) {
                ...
                Meteor.call('checklistvalues.generateValues', this.state.params
                    ...
                    if (err) {
                        ...
                        window.location.assign("/Checklist?mid=" + res.mid + "&type=H-Promise&version=" + res.version);
                    }
                });
            }
...
export default HPromiseContainer = createContainer(() => {
    ...
    let checklisttypes = [];
    let initchecks = [];//ChecklistMains.find({
     return {
        readyUser: userReady,
